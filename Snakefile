...
plain_samples = ['Rhodo', 'WWRhodo', 'WW']
magn_samples = ['RhodoMagn', 'WWRhodoMagn', 'WWMagn']
mock_samples = ['RhodoMock', 'WWRhodoMock', 'WWMock']
...
rule draw_abundance_comparisons:
  ...
  params:
    {'Type' : 'bacteria',
     'Samples' : plain_samples + magn_samples + mock_samples,
...
rule draw_tanglegrams:
  input:
    ...
    euk_abunds="tables/18S_abunds.txt"
  output:
    "figures/plain_tanglegram.png",
    "figures/plain_tanglegram_normalised.png",
